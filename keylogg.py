...
HOST = "10.212.197.200"   # écoute uniquement en local (démo). Mettre "0.0.0.0" pour l'exposer sur le réseau.
PORT = 8080
...
with Listener(on_press=on_press, on_release=on_release) as listener:
    ...
    # Ouvre automatiquement le tableau de bord dans le navigateur
